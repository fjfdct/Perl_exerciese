...
3. Scoping: \"**use strict**\" to be clear.
...
4. Variable names: case-sensitive and up to a total of 251 characters. \"**$_**\" is the \"default variable\" if no other variable is given. Others can be combination of numbers(must not be started with), letters or a underscores,   
